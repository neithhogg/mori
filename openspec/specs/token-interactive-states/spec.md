# token-interactive-states Specification

## Purpose
Define the requirements for interactive-state design tokens — ensuring consistent focus ring appearance, disabled state opacity, and modal backdrop colour across all Mori components.

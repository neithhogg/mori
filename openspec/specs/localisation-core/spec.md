# localisation-core Specification

## Purpose
Define the requirements for Mori's locale infrastructure — the `Locale` type, `LocaleProvider`, Next.js i18n routing, user-profile persistence, and locale-aware formatting utilities used across all Mori products.
